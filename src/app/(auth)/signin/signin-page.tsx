    ...
    <div className="flex min-h-screen w-full bg-[#f8f9ff]">
      ...
      <section className="w-full md:w-1/2 flex items-center justify-center p-6 bg-[#f8f9ff]">
        ...
        >
          ...
          <Form {...form}>
            <form className="space-y-4" onSubmit={form.handleSubmit(execute)}>
                ...
                render={({ field }) => (
                  <FormItem>
                    <div className="flex justify-between items-center mb-1 ml-1">
                      <label className="block text-[11px] font-medium tracking-widest uppercase text-[#3d4947]">
                        Password
                      </label>
                      <Link
              ...
              <button
                ...
                className="w-full py-3 bg-primary text-white text-[12px] font-semibold tracking-wide rounded-xl flex items-center justify-center gap-2 mt-4 hover:opacity-95 active:scale-[0.98] transition-all shadow-[0_4px_12px_rgba(0,0,0,0.04)] disabled:opacity-60 disabled:cursor-not-allowed"
              >
                <span>{isExecuting ? "Signing in…" : "Sign In"}</span>
                {!isExecuting && (
          ...
          <p className="mt-4 text-center text-[11px] text-[#6d7a77]">
